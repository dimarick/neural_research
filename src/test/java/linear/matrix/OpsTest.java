...
public class OpsTest {
    ...
    @Test
    public void multipleLargeVectorTransposedTest() {
        float[] data1 = new float[400000000];
        float[] data2 = new float[10000];
        Arrays.fill(data1, 1.0f);
        Arrays.fill(data2, 1.0f);
        ...
        for (var i = 0; i < 20; i++) {
            result = Ops.multipleTransposed(
                    new MatrixF32(40000, 10000, data1),
                    new MatrixF32(1, 10000, data2)
            ).getData();
        }
    ...
    public void multipleLargeConcurrentTest() {
        float[] data1 = new float[40000000];
        float[] data2 = new float[40000000];
        Arrays.fill(data1, 1.0f);
        Arrays.fill(data2, 1.0f);

        float[] result = Ops.multipleConcurrent(
                new MatrixF32(4000, 10000, data1),
                new MatrixF32(10000, 4000, data2),
                20
        ).getData();
        assertEquals(
                16000000,
        ...
        assertEquals(10000f, result[0], 0.0f);
        assertEquals(10000f, result[16000000 - 1], 0.0f);
    }
    ...
    public void multipleTransposedLargeConcurrentTest() {
        ...
        float[] result = Ops.multipleTransposedConcurrent(
                new MatrixF32(4000, 10000, data1),
                new MatrixF32(4000, 10000, data2),
                20
        ).getData();
        assertEquals(
                16000000,
