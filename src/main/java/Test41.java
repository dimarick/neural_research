...
/**
 * Тест лучшего результата с адаптивным dropout input
 */
public class Test41 extends TestBase {
        ...
        try (
            ...
            for (var i = 0; i <= 8; i++) {
                for (var j = 0; j <= 6; j++) {
                    ...
                    result = train(testImages, testLabels, trainImages, trainLabels, speed * speedOptimizerScale, dropoutInputAlgo, p);
